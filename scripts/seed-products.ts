...
async function seed() {
  ...
  const brands = [
    ...
    { name: 'Moulinex', slug: 'moulinex', logo_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Moulinex_logo.svg/2560px-Moulinex_logo.svg.png' },
  ...
  const products: ProductSeed[] = [
    ...
    },
    {
      ...
      main_image_url: 'https://m.media-amazon.com/images/I/71fSEy+dPoL._AC_SL1500_.jpg',
